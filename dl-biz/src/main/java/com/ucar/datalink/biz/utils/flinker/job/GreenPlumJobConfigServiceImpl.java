...
public class GreenPlumJobConfigServiceImpl extends AbstractJobConfigService {
    ...
    public String createReaderJson(MediaSourceInfo info, List<ColumnMeta> metas, JobExtendProperty property, String mediaName) {
        ...
        String json = "";
        try{
            String etlUrl = MessageFormat.format(FlinkerJobConfigConstant.GREENPLUM_URL, etlHost, port, schema);
            String url = MessageFormat.format(FlinkerJobConfigConstant.GREENPLUM_URL, ip, port, schema);
            String columns = buildColumnParm( metas );
            String reader = loadJobConfig(FlinkerJobConfigConstant.GREENPLUM_READER);
    ...
    public String createWriterJson(MediaSourceInfo srcInfo, MediaSourceInfo info, MediaMeta srcMediaMeta, JobExtendProperty property, String mediaName) {
        ...
        try{
            ...
            String url = MessageFormat.format(FlinkerJobConfigConstant.GREENPLUM_URL, ip, port, sehema);
            String columns = buildColumnParm( target.getColumn() );
            String reader = loadJobConfig(FlinkerJobConfigConstant.GREENPLUM_WRITER);
