package com.ucar.datalink.flinker.plugin.reader.esreader.client.rest.alias;
...
public class SearchAlias extends AbstractRequestEs {
	...
	public Object searchAlias(SearchAliasVo vo) {
		return ProcessResult.parseResult(super.processRequest(vo, null), ESEnum.ParseEnum.SEARCHALIAS);
	}
