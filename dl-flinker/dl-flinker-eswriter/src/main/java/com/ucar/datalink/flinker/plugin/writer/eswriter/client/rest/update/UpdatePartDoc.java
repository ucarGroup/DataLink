...
public class UpdatePartDoc extends AbstractRequestEs {
	...
	/* (non-Javadoc)
	 * @see com.ucar.datalink.flinker.plugin.writer.eswriter.AbstractRequestEs#getHttpUriRequest(com.ucar.datalink.flinker.plugin.writer.eswriter.vo.DocumentVo)
	 */
	@Override
