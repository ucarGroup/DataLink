package com.ucar.datalink.flinker.core.util.container;
...
public class CoreConstant {
	...
	public static final String DATAX_CORE_CONTAINER_JOB_EXECUTION_ID = "core.container.jobexecution.id";
	...
	public static String DATAX_ADMIN_CONF = StringUtils.join(new String[] { 
			DATAX_HOME, "conf", "admin.properties" }, File.separator);
}
