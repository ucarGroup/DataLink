package com.ucar.datalink.flinker.core.util;
...
public final class ConfigParser {
    ...
    public static Configuration parse(final String jobPath) {
        ...
        return assembleConfiguration(configuration);
    }


    public static Configuration assembleConfiguration(Configuration configuration) {
        configuration.merge(
