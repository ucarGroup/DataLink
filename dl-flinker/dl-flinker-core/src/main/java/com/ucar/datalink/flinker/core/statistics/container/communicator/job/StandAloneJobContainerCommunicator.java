package com.ucar.datalink.flinker.core.statistics.container.communicator.job;
...
import com.ucar.datalink.flinker.core.statistics.container.collector.ProcessInnerCollector;
...
public class StandAloneJobContainerCommunicator extends AbstractContainerCommunicator {
    ...
    public void report(Communication communication) {
        super.getReporter().reportJobCommunication(super.getJobId(), super.getExecutionId(), communication);
