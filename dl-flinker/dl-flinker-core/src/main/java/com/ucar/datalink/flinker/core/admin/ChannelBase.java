...
public abstract class ChannelBase {
    ...
    protected static volatile int recoredSpeedByZk;
    ...
    public ChannelBase(final Configuration configuration) {
        ...
        synchronized (isFirstPrint) {
            if (isFirstPrint) {
                ChannelBase.LOG.info("Channel set byte_speed_limit to " + byteSpeed
                        + (byteSpeed <= 0 ? ", No bps activated." : "."));
                ChannelBase.LOG.info("Channel set record_speed_limit to " + recordSpeed
    ...
    public static void setRecoredSpeedByZk(int recoredSpeedByZk) {
        ChannelBase.recoredSpeedByZk = recoredSpeedByZk;
    }

    public static void setByteSpeedByZk(int byteSpeedByZk) {
        ChannelBase.byteSpeedByZk = byteSpeedByZk;
    }
...
//                currentCommunication.getLongCounter(CommunicationTool.STAGE) + 1);
    ...
    private void statPush(long recordSize, long byteSize) {
        ...
        this.byteSpeed = ChannelBase.byteSpeedByZk;
        this.recordSpeed = ChannelBase.recoredSpeedByZk;
