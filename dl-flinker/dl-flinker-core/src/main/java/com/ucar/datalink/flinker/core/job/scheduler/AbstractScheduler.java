package com.ucar.datalink.flinker.core.job.scheduler;
...
public abstract class AbstractScheduler {
    ...
    public void schedule(List<Configuration> configurations) {
        ...
        this.containerCommunicator.report(lastJobContainerCommunication);//added by lubiao
        ...
        try {
            ...
            ErrorRecord.addError("捕获到InterruptedException异常!"+e.getMessage());
