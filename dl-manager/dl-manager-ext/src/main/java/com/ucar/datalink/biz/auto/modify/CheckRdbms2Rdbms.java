...
public class CheckRdbms2Rdbms implements ICheck {
    ...
    public void check(MediaSourceInfo srcInfo, MediaSourceInfo destInfo, JobConfigInfo info) throws Exception {
        ...
        List<ColumnMeta> columnMetas = SyncModifyUtil.getNewColumnInfo(srcInfo,info.getJob_media_name());
        ...
        SyncModifyUtil.modifyJsonColumn(info,srcModifyInfo, destModifyInfo);
