...
public interface JobDAO {
     ...
     * @param info
     */
    public long addJobConfig(JobConfigInfo info);
     ...
     * @param info
     */
    public void updageJobConfig(JobConfigInfo info);

    /**
     * 修改job关联的src_media_id和target_media_id
     * @param info
     */
    public void updateRelationMediaSource(JobConfigInfo info);

    /**
     * 更新一个job的内容
     * @param info
     */
    public void updateJobConfigContent(JobConfigInfo info);
     ...
     * @return
     */
    public List<JobConfigInfo> selectBtachJobConfig(int start,int count);
     ...
     * @return
     */
    public List<JobConfigInfo> selectBatchJobConfigByDBType(@Param("srcType")String srcType, @Param("destType")String destType, @Param("srcName")String srcName,
     ...
     * @param info
     */
    public void addJobExecution(JobExecutionInfo info);
     ...
     * @param id
     */
    public void updateJobExecutionState(String state,String errMsg,long id);
     ...
     * @return
     */
    public List<JobExecutionInfo> selectBtachJobExecutioin(int start, int count);

    /**
     * 根据任务的状态分页查询
     * @return
     */
    public List<JobExecutionInfo> selectBatchJobExecutionByStateType(@Param("stateType")String stateType,@Param("job_id")long job_id,
...
@Param("mediaName")String mediaName, @Param("startTime")String startTime, @Param("endTime")String endTime);
     ...
     */
    public List<JobExecutionInfo> selectBatchJobExecutionByOptimized(@Param("stateType")String stateType,
     ...
     * @return
     */
    public List<JobExecutionInfo> getJobExecutionByJobIdForPaging(long id,long startPage,long count);
     ...
     * @return
     */
    public List<JobExecutionInfo> getAllFailureJobByTimeFrame(Timestamp startTime, Timestamp endTime);
