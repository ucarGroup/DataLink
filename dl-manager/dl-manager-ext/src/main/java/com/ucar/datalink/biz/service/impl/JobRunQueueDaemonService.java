...
public class JobRunQueueDaemonService extends JobDaemonService {
    ...
    public void initialized() {
        ...
        //Runtime.getRuntime().addShutdownHook(new Thread(new Destory(), "job-run-queue-destory"));
    }
    ...
    private long scheduleJob(long jobConfigId) {
        try {
            ...
            logger.info("[JobRunQueueListener]scheduleJob DataxCommand -> " + command.toString());
