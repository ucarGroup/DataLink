        ...
        <div class="row">
            <form id="add_form" class="form-horizontal" role="form">
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-add-name">Dove集群名称</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="doveMediaSrcParameter.zkMediaSourceId" id="form-add-zkMediaSourceId"
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"
                           for="form-add-clusterPrefix">Dove集群前缀</label>

                    <div class="col-sm-9">
                        <input type="text" style="width:350px;height:35px" id="form-add-clusterPrefix"
                               name="doveMediaSrcParameter.clusterPrefix" class="col-xs-10 col-sm-5"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"
                    ...
                    <div class="col-sm-9">
                        <input type="text" style="width:350px;height:35px" id="form-add-topic"
                               name="doveMediaSrcParameter.topic" class="col-xs-10 col-sm-5"/>
                    </div>
                </div>
                <div class="form-group">
