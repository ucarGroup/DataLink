                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" style="width:350px;height:35px" id="form-add-httpPort"
                               name="esMediaSrcParameter.httpPort" class="col-xs-10 col-sm-5" value="9200"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="form-add-tcpPort" name="esMediaSrcParameter.tcpPort"
                               class="col-xs-10 col-sm-5" style="width:350px;height:35px" maxlength="50" value="9300"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="form-add-userName" name="esMediaSrcParameter.userName"
                               class="col-xs-10 col-sm-5" style="width:350px;height:35px" maxlength="50" value="sdk"/>
                    </div>
                </div>
                <div class="form-group">
