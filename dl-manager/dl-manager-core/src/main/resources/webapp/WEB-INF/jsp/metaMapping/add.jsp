        ...
        <div class="row">
            <form id="add_form" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select multiple=""
                            ...
                            <option grade="2" value="RDBMS" >RDBMS</option>
                            <option grade="3" value="HDFS"  >HDFS</option>
                            <option grade="4" value="ElasticSearch" >ElasticSearch</option>
                            <option grade="5" value="SDDL" >SDDL</option>
                            <option grade="6" value="DATAX" >DATAX</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" style="width:350px;height:35px" name="srcMappingType" class="col-xs-10 col-sm-5"
                               id="form-add-src-mapping"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" style="width:350px;height:35px" name="targetMappingType" class="col-xs-10 col-sm-5"
                               id="form-add-target-mapping"/>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function doAdd() {
        ...
        $.ajax({
            type: "post",
            url: "${basePath}/metaMapping/doAdd",
            dataType: "json",
