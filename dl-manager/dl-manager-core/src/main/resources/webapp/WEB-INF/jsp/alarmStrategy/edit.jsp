    ...
    <div class="page-content">
        <div class="row">
            <form id="add_form" class="form-horizontal" role="form">
                <input type="hidden" name="id"  value="${alarmStrategyInfo.id}"/>
                <div class="tabbable">
                        ...
                        <div id="basicId" class="tab-pane in active">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-4 form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input  type="text" name="name" style="width:100%;" value="${alarmStrategyInfo.name}" id="form-add-name">
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <label class="col-sm-4 control-label no-padding-right">报警策略组</label>
                                    <div class="col-sm-8">
                                        <select multiple="" disabled="true" name="priorityId" class="form-add-priorityId tag-input-style"
                                                data-placeholder="Click to Choose..." id="form-add-priorityId"
                                                style="width: 200px;">
                                            <c:forEach items="${taskPriorityInfos}" var="item">
                                                <option value="${item.id}"
                                                        <c:if test="${item.id == alarmStrategyInfo.priorityId}">
                                                            selected = "selected"
                                                        </c:if>
                                                >${item.name}</option>
                                            </c:forEach>
                                        ...
                                        <select multiple="" name="monitorType" class="form-add-monitorType tag-input-style"
                                            ...
                                            <c:forEach items="${monitorTypeList}" var="item">
                                                <option value="${item.key}"
                                                        <c:if test="${item.key == alarmStrategyInfo.monitorType}">selected</c:if>
                                                >${item.desc}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                            ...
                            <c:forEach items="${alarmStrategyInfo.strategys}" var="item" varStatus="itemStatus">
                                ...
                                <div >
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input  type="text" value="${item.timeRange}" id="form-add-timeRange" name="timeRange" style="width:100%;" placeholder="00:00-23:59">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="${item.threshold}" id="form-add-threshold" name="threshold" style="width:100%;" value="5">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input  type="text" value="${item.intervalTime}" id="form-add-intervalTime"  name="intervalTime" style="width:100%;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select multiple="" name="isPhone" class="form-add-isPhone tag-input-style"
                                                        ...
                                                        style="width: 200px;">
                                                    <option value="1" <c:if test="${item.phone == true}">selected</c:if>
                                                    >是</option>
                                                    <option value="0" <c:if test="${item.phone == false}">selected</c:if> >否</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select multiple="" name="isDingD" class="form-add-isDingD tag-input-style"
                                                    ...
                                                    <option value="1" <c:if test="${item.dingD == true}">selected</c:if>
                                                    >是</option>
                                                    <option value="0" <c:if test="${item.dingD == false}">selected</c:if> >否</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select multiple="" name="isSMS" class="form-add-isSMS tag-input-style"
                                                        ...
                                                        style="width: 200px;">
                                                    <option value="1" <c:if test="${item.sMS == true}">selected</c:if>
                                                    >是</option>
                                                    <option value="0" <c:if test="${item.sMS == false}">selected</c:if> >否</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <textarea type="text" name="other"  class="col-sm-12" id="form-add-other"
                                              style="margin: 0px;height: 106px;width: 80%;">${item.otherConfig}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function doEdit() {
        ...
        $.ajax({
            type: "post",
            url: "${basePath}/alarmStrategy/doEdit?priorityId="+$("#form-add-priorityId").val(),
            dataType: "json",
    ...
    function validateForm() {
        ...
        var count = $('#basicId').find('input[name=timeRange]').length;
        for (var i = 0; i < count; i++) {
            var e = $('#basicId').find('input[name=timeRange]').eq(i).val();
            if ($.trim(e) == '') {
                alert('时间范围不能为空!');
                return false;
            }
        }
        count = $('#basicId').find('input[name=threshold]').length;
        for (var i = 0; i < count; i++) {
            var e = $('#basicId').find('input[name=threshold]').eq(i).val();
            if ($.trim(e) == '') {
                alert('延迟阈值不能为空!');
                return false;
            }
        }
        count = $('#basicId').find('input[name=intervalTime]').length;
        for (var i = 0; i < count; i++) {
            var e = $('#basicId').find('input[name=intervalTime]').eq(i).val();
            if ($.trim(e) == '') {
                alert('报警间隔不能为空!');
                return false;
            }
        }
        count = $('#basicId').find('select[name=isPhone]').length;
        for (var i = 0; i < count; i++) {
            var e = $('#basicId').find('select[name=isPhone]').eq(i).val();
            if ($.trim(e) == '') {
                alert('电话报警不能为空!');
                return false;
            }
        }
        count = $('#basicId').find('select[name=isDingD]').length;
        for (var i = 0; i < count; i++) {
            var e = $('#basicId').find('select[name=isDingD]').eq(i).val();
            if ($.trim(e) == '') {
                alert('钉钉报警不能为空!');
                return false;
            }
        }
        count = $('#basicId').find('select[name=isSMS]').length;
        for (var i = 0; i < count; i++) {
            var e = $('#basicId').find('select[name=isSMS]').eq(i).val();
            if ($.trim(e) == '') {
                alert('短信报警不能为空!');
                return false;
            }
         ...
         count = $('#copyBaseSourceDivId').find('input[name=timeRange]').length;
        for (var i = 0; i < count; i++) {
