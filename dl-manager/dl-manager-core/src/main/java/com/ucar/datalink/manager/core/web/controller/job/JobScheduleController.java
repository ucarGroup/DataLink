...
import com.ucar.datalink.biz.cron.http.HttpCronUtil;
import com.ucar.datalink.biz.cron.http.HttpQuartzJob;
import com.ucar.datalink.biz.cron.http.JobTaskScheduleManager;
...
import com.ucar.datalink.util.DateExpressionEngine;
import com.ucar.datalink.util.GetBetweenDate;
...
public class JobScheduleController {
    ...
    static {
        ...
        //int maxThreadAmount = (int)Runtime.getRuntime().availableProcessors();
        //ThreadPoolExecutor pool = new ThreadPoolExecutor(1,maxThreadAmount,0, TimeUnit.SECONDS,new ArrayBlockingQueue<Runnable>(maxThreadAmount));
        //executorService.su
    }
    ...
    public String doStartSync(HttpServletRequest request) {
        ...
        try {
            ...
            //将 DATAX_CURRENT_DATE 和 DATAX_PRE_DATE 替换为指定的时间 ，并运行
            //if( !fillDataSet.contains(name) ) {
            //
            //}
