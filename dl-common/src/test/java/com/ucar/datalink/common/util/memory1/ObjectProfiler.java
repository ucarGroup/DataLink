package com.ucar.datalink.common.util.memory1;
...
public abstract class ObjectProfiler {
    ...
    private static IdentityHashMap visited = new IdentityHashMap(80000);
     ...
     */
    public synchronized static long sizeof(final Object obj) {
        try {
